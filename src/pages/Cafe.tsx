...
import { MapPin, Clock, Phone, Mail, Instagram, Coffee, Info, Edit2, Save, X, Plus, Trash2, Laptop, Calendar } from 'lucide-react';
...
const Cafe: React.FC = () => {
  ...
  const canManageCafe = isAdmin || (isOrganizer && currentUser?.canManageCafe);
